  ...
  return (
    <div>
      <div className='flex items-center justify-center'>
        <div className='grid grid-cols-2 mt-[-2.5rem] bg-purple-200 p-2 rounded-lg'>
          <input
            type="text"
            id="search"
            value={search}
            ...
            className='py-4 lg:pr-44 pl-2 border-r-2 border-purple-200 border-dashed'
          />
          <div>
            <DatePicker
      ...
      <div className='flex justify-center mt-5'>
        <div className='w-10/12'>
          <h1 className='text-5xl text-gray-800'>FROM A TO Z</h1>
          <p className='text-gray-700 font-bold'>OUR RANGE OF HOLIDAY DESTINATIONS IS SPREADING OVER ALL EUROPE</p>
