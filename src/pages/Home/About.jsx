...
function About() {
  ...
  return (
    <main className='bg-red-50'>
      <div className='w-full h-78 bg-red-500 flex flex-col justify-center items-center'>

        <div className='w-9/12 items-center justify-center flex flex-col'>
          <h1 className='text-5xl text-red-50 flex my-5 text-center'>TOP-RATED TRAVEL AGENTS</h1>
          <p className='text-xl text-red-50 text-center'>Connect with one of our professional travel agents —
        ...
        <div className='flex justify-center items-center mt-4 mb-10'>
          <div className='p-2 lg:p-5 w-4/12'>
            <h1 className='text-2xl lg:text-5xl text-red-50'>
              4.85/5
              <StarBorderIcon style={{ horizantalAlign: 'middle' }} />
            </h1>
            <p className='text-red-50'>Average Agent Rating by Past Clients</p>
          </div>
          <div className='p-2 lg:p-5 w-4/12'>
            <h1 className='text-2xl lg:text-5xl text-red-50'>99.23 %</h1>
            <p className='text-red-50'>Recommended by Past Clients</p>
          </div>
          <div className='p-2 lg:p-5 w-4/12'>
      ...
      <div className='w-full h-78 flex flex-col justify-center items-center mt-[-2rem]'>
        <div className='flex flex-col lg:flex-row lg:w-9/12 justify-center items-center bg-gray-200 rounded-2xl lg:rounded-full m-2'>
          <div>
            <button className='text-2xl lg:text-3xl text-red-600 lg:bg-gray-200 lg:py-2 px-6 rounded-full lg:mr-9 hover:bg-gray-100 active:bg-gray-100'
          ...
          <div>
            <button className='text-2xl lg:text-3xl text-red-600 lg:bg-gray-200 lg:py-2 px-6 rounded-full hover:bg-gray-100 active:bg-gray-100'
