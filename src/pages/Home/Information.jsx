    ...
    return (
        <div>
            <h5 className='text-xl' onClick={toggleAnswerVisibility}>
                <KeyboardArrowDownIcon className='text-purple-500' />
                {question}
            </h5>
        ...
        <div className="flex items-center justify-center">
            <div className='flex flex-col lg:flex-row w-10/12'>
                <div className='flex flex-col m-8 lg:w-5/12'>
                    <h3 className='text-4xl font-bold text-purple-600 mb-5 text-center'>Important informations?</h3>
                ...
                <div className='flex flex-col m-8 lg:w-5/12'>
                    <h3 className='text-4xl font-bold text-purple-600 mb-5 text-center'>Curious?</h3>
                    <div className='ml-10'>
                        <FaqItem
